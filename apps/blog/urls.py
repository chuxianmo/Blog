...
from .views import (homepage, IndexView, DetailView, CategoryView, TagView, AboutView,
                    SilianView, MySearchView, ArchiveView, TimelineView)

urlpatterns = [
    url(r'^$', homepage, name='homepage'),  # 网站首页
    url(r'^index/$', IndexView.as_view(), name='index'),  # 博客主页，自然排序
